    ...
    PlayerPosition.update = function(skeleton){
        ...
        if (player !== null){
            ...
            if (PlayerPosition['lastPositionPlayer'+player] !== PlayerPosition['positionPlayer'+player]){
                //window.log('Player 1 Position: ' + (PlayerPosition.positionPlayer1 !== null ? PlayerPosition.positionPlayer1 : '') + '; Player 2 Position: ' + (PlayerPosition.positionPlayer2 !== null ? PlayerPosition.positionPlayer2 : ''));
...
(function(){
    ...
    {   
        ...
        this.gestureName = 'playerposition';
        this.person = person;
