...
(function(){
    ...
    function SwipeCondition(person, options){
        ...
        this.Check = function(skeleton)
        {
            ...
            //window.log(JSON.stringify(handMovement));
    ...
    SwipeGesture.Options = {Hand:JointType.HandRight, allowedDirections:[KinectGestures.Direction.Left]};
