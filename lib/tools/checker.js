...
(function(){
    ...
    Checker.prototype.SimpleAbsoluteVelocity = function(jointType, firstTime, secondTime)
    {
        ...
        //window.log(KinectGestures.SkeletonMath.DistanceBetweenPoints(this.person.GetLastSkeleton(firstTime).joints[jointType].position, this.person.GetLastSkeleton(secondTime).joints[jointType].position))
        //window.log(this.person.GetLastSkeleton(firstTime).joints[jointType].position.x - this.person.GetLastSkeleton(secondTime).joints[jointType].position.x);
