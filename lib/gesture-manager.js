        ...
        { 
            ...
            if (trackedSkeletons.length === 0)
            {
              for (var i = currentlyTrackedPlayers.length - 1; i >= 0; i--) {
                ...
                KinectGestures.emit('playerLost', {trackingId:currentlyTrackedPlayers[i].trackingId, playerNum:player ? player.playerNum : -1});
              }
            }
            else{ 
              ...
              for (i = losts.length - 1; i >= 0; i--) {
                ...
                KinectGestures.emit('playerLost', {trackingId:losts[i].trackingId, playerNum:player ? player.playerNum : -1});
              }
            } 
        }
